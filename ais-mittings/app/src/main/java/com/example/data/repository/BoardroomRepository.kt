...
class BoardroomRepository(
    ...
    private fun generateDefaultAdvisors(): List<AdvisorEntity> {
        // پیش‌فرض: ۴ کارگروه سازمانی (حوزه‌های کلان). تعداد کارگروه‌ها پویاست — کاربر می‌تواند از
        // داخل اپ گروه اضافه یا حذف کند؛ هر گروه جدید کپی یکسان همان ساختار ۵ جایگاه را می‌گیرد.
        val advisorDefinitions = listOf(
            AdvisorDef(1, "گروه ۱: استراتژی و برنامه‌ریزی 📈", "#A855F7", "trending"),
            AdvisorDef(2, "گروه ۲: فناوری و نوآوری 💻", "#38BDF8", "code"),
            AdvisorDef(3, "گروه ۳: مالی و منابع 🏦", "#34D399", "pie_chart"),
            AdvisorDef(4, "گروه ۴: حقوقی و انطباق ⚖️", "#F472B6", "balance")
        )

        // نقش‌های ۵ جایگاه مشاور هوش مصنوعی هر گروه (حوزه‌های تخصصی سازمانی)
        val slotRoles = mapOf(
            1 to listOf(
                "تحلیل‌گر ارشد استراتژیک" to "تحلیل محیط رقابتی، فرصت‌ها و تهدیدهای کلان سازمان",
                "کارشناس برنامه‌ریزی و بودجه‌ریزی" to "تدوین اهداف کمی، زمان‌بندی و شاخص‌های عملکرد",
                "کارشناس ارزیابی ریسک و انطباق" to "شناسایی ریسک‌های اجرایی و تدابیر کاهش آن‌ها",
                "نقاد و مدافع منافع سازمان (Devil's Advocate)" to "نقد سازنده طرح‌ها و کشف نقاط ضعف پنهان",
                "تدوین‌گر گزارش و جمع‌بندی نهایی" to "تلفیق دیدگاه‌ها در قالب مصوبه‌ای قابل اجرا"
            ),
            2 to listOf(
                "معمار ارشد فناوری اطلاعات" to "طراحی معماری سیستم‌ها و انتخاب فناوری مناسب",
                "متخصص هوش مصنوعی و داده" to "ارزیابی راهکارهای داده‌محور و مدل‌های هوش مصنوعی",
                "کارشناس امنیت سایبری" to "تحلیل تهدیدهای امنیتی و الزامات حفاظت از داده",
                "کارشناس نوآوری و تحول دیجیتال" to "شناسایی فرصت‌های نوآوری و اتوماسیون فرایندها",
                "مدیر پروژه و اجرای فنی" to "برنامه‌ریزی اجرایی، منابع انسانی و زمان‌بندی تحویل"
            ),
            3 to listOf(
                "تحلیل‌گر مالی ارشد" to "تحلیل صورت‌های مالی، جریان نقدی و سودآوری",
                "کارشناس بودجه‌بندی و کنترل هزینه" to "تخصیص بهینه منابع مالی و پایش هزینه‌ها",
                "کارشناس سرمایه‌گذاری و ارزیابی طرح‌ها" to "ارزیابی بازگشت سرمایه (ROI) و تحلیل حساسیت",
                "کارشناس تأمین مالی و منابع انسانی" to "بررسی راهکارهای تأمین مالی و بهینه‌سازی نیروی انسانی",
                "مدیر گزارش‌های مالی و شفافیت" to "تدوین گزارش‌های مالی شفاف برای تصمیم‌گیری رییس جلسه"
            ),
            4 to listOf(
                "مشاور حقوقی ارشد" to "بررسی قراردادها، تعهدات و پیامدهای حقوقی تصمیم‌ها",
                "کارشناس انطباق و مقررات (Compliance)" to "پایش قوانین، استانداردها و الزامات رگولاتوری",
                "کارشناس مدیریت قراردادها" to "تنظیم، بازبینی و پایش اجرای قراردادها",
                "کارشناس حل اختلاف و مذاکره" to "مدیریت اختلافات بالقوه و راهبردهای مذاکره",
                "کارشناس حکمرانی داده و حریم خصوصی" to "انطباق پردازش داده‌ها با قوانین حفاظت از اطلاعات"
            )
        )
        ...
        return advisorDefinitions.map { (id, name, color, icon) ->
            ...
            val slots = (1..5).map { slot ->
                ...
                SubAgentSlot(
                    ...
                    systemPersona = "شما $roleName در «$name» هستید. مأموریت: $roleDesc. پاسخ‌های شما باید دقیق، حرفه‌ای، مبتنی بر شواهد و متناسب با سطح تصمیم‌گیری رییس جلسه باشد."
                )
            }
            AdvisorEntity(
                id = id,
